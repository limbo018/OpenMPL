/**
 * @file   DancingLinkColoringOpt.h
 * @author Wei LI
 * @date   March 2020
 */
#ifndef SIMPLEMPL_DANCINGLINKCOLORINGOPT_H
#define SIMPLEMPL_DANCINGLINKCOLORINGOPT_H
...
class DancingLinkColoringOpt : public limbo::algorithms::coloring::Coloring<GraphType>
{
	public:
        /// @nowarn 
		...
		/// constructor
        /// @param g graph 
		DancingLinkColoringOpt(graph_type const& g) 
			: base_type(g)
		{}
		/// destructor
		virtual ~DancingLinkColoringOpt() {}
	...
	protected:
		...
		virtual double coloring()
        {
            ...
            double cost2 = std::numeric_limits<double>::max();
            if(cost1 > 0){
                cost2 = solve_by_dancing_link_with_at_most_two_stitches(cost1);
            }
