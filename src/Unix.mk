...
CXX = g++ -std=gnu++11
CXXFLAGS_BASIC =  -fmax-errors=1 -DQDEBUG -W -Wall -Wextra -Wreturn-type -ansi -m64 -Wno-deprecated -Wno-unused-local-typedefs
CXXFLAGS_DEBUG = -g -rdynamic   $(CXXFLAGS_BASIC) 
