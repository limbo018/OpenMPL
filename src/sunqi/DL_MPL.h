 ...
 */
std::vector<std::list<Edge_Simple>> Read_Graph_File(std::string filename, int & vertex_numbers, int & edge_numbers); //, int & mask_numbers);
 ...
 * 
 */
void Convert_to_Exat_Cover(int & row_number, int & col_numbers, std::string infilename, std::string Exact_Cover_Filename, bool whether_BFS,
