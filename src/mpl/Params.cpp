...
bool CmdParser::operator()(int argc, char** argv)
{
    ...
    desc.add_option(Value<bool>("-help", &help, "toggle printing help message").toggle(true).default_value(false).toggle_value(true).help(true))
        ...
        .add_option(Value<bool>("-gen_stitch",  &parms.gen_stitch,  "toggle controlling stitch generation, default is false").toggle(true).default_value(defaultParms.gen_stitch).toggle_value(true))
		.add_option(Value<bool>("-use_stitch",  &parms.use_stitch,	"toggle controlling whether use stitch in coloring, default is false").toggle(true).default_value(defaultParms.use_stitch).toggle_value(true))
